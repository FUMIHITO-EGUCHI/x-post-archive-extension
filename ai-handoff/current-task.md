...
- `2026-04-14 Codex`: `2026-04-14-remove-dead-code-archive-service` completed on `feature/full-codebase-review-2026-04-14-fixes`; removed dead `ensureTagAssignments`, `assignPostTagsDirectly`, and maintenance-service duplicate `createBackupFilename`; typecheck/build passed
- `2026-04-14 Codex`: committed `2026-04-14-fix-orphaned-tag-on-preview-cancel` as `e5a9a4f Avoid tag creation during bulk preview`
- `2026-04-14 Codex`: started `2026-04-14-remove-dead-code-archive-service` on `feature/full-codebase-review-2026-04-14-fixes`
